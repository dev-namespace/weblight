...
const commands = {
    sendHighlight: data => {
        sendPOST('http://www.weblight.com:3000/hl/add', Object.assign({user: 'namespace'}, data))
    },
    ...
    queryHighlights: (data, callback) => {
        sendPOST('http://www.weblight.com:3000/hl/query', {user: 'namespace', query: data}, response => {
            callback(response || {highlights: []})
        })
    }
}
